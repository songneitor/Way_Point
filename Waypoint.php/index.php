    ...
    <div class="sidebar " style=right:0;display:none; id="mySidebar">
        ...
        <hr>
            ...
            <div class="sidebar-nav">
                <a href="meupainel.php" class="butao-sidebar">Meu painel de eventos</a>
...
<div class="container2">
    <div class="row">
        ...
        <div class="card">
            ...
            <img src="./img/img1/dois.png" alt="" class="image">
        </div>
    </div>
    ...
    <div class="row">        
        <div class="card">
            ...
            <img src="./img/img1/tres.png" alt="" class="image">
        </div>
        <div class="card">
          
            <img src="./img/img1/quatro.png" alt="" class="image">
        </div>
    </div>
</div>
...
<div class="container2">
    ...
    <div class="row">        
        <div class="card">
        <img src="./img/img1/sete.png" alt="" class="image">
        </div>
        <div class="card">
