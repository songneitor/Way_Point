...
<div class="butoespainel">
    <button href="meupainel.php" class="butaopainel" style="color: #000000; background-color: #0D9ECA; border-width: 2px 2px 2px 2px; box-shadow: #000000 4px 4px; border-color: #000000;">Inscritos</button>
    <button href="painelevento.php"class="butaopainel" ><a href="painelevento.php">Meus eventos</a></button>
</div>
...
<div class="containerpainel">
    <div class="rowpainel">
        ...
        <img src="./img/img1/um.png" alt="" class="image">
        </div>
        <div class="cardpainel">
           
            <img src="./img/img1/cinco.png" alt="" class="image">
        </div>
        <div class="cardpainel">
           
            <img src="./img/img1/seis.png" alt="" class="image">
        </div>
    </div>
